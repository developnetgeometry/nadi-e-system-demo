...
interface DuspSubmitDialogProps {
  isOpen: boolean;
  onClose: () => void;
  claim: any;
}

const DuspSubmitDialog: React.FC<DuspSubmitDialogProps> = ({ isOpen, onClose, claim }) => {
  ...
  const handleSubmit = async () => {
    try {
      await updateClaim({
        claim_id: claim.id,
        claim_status: 3, // Set claim_status to 3
...
export default DuspSubmitDialog;