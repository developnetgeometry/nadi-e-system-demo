...
const NMS = async ({
    ...
    const allAttachments = nms.flatMap(site => site.attachments_path);
    ...
    if (hasContent) {
        ...
        for (const path of allAttachments) {
            ...
            drawSectionTitle(currentPage, "4.2 NMS", 40, currentY, currentWidth - 80, 24);
            currentY -= 34;
        ...
        drawSectionTitle(emptyPage, "4.2 NMS", 40, emptyY, pageWidth - 80, 24);
        emptyY -= 34;
        const boxX = 40;
