...
import IncentiveBarChart from "./IncentiveBarChart";
/**
 * Generate a chart image (base64 PNG) from salary data for PDF embedding
 * @param incentive ManpowerData[]
 * @returns Promise<string> base64 image string
 */
export async function generateIncentiveBarChartImage(incentive) {
    ...
    root.render(React.createElement(IncentiveBarChart, { data: chartData, width: 650, height: 380 }));
