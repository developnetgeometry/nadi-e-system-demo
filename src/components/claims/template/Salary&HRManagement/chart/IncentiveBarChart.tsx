...
import { BarChart, Bar, XAxis, YAxis, Legend, Cell, CartesianGrid, ResponsiveContainer } from "recharts";
import { SALARY_CHART_COLORS, getDefaultColor } from "./chart-util";

interface IncentiveBarChartProps {
  data: any[];
  width?: number;
  height?: number;
...
export const IncentiveBarChart: React.FC<IncentiveBarChartProps> = ({ 
  data, 
  width = 650, 
  height = 420,
