...
import { updateSuperAdminProfile } from "@/components/profile/hook/use-superadmin-profile";
import { useUserMetadata } from "@/hooks/use-user-metadata";

interface ProfileEditDialogSuperAdminProps {
    open: boolean;
...
const ProfileEditDialogSuperAdmin: React.FC<ProfileEditDialogSuperAdminProps> = ({
    open,
    onOpenChange,
    profileData,
    onSave,
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            // Call the updateSuperAdminProfile function with the updated formState
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[90vw] max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    <DialogTitle>Edit Profile SuperAdmin</DialogTitle>
...
export default ProfileEditDialogSuperAdmin;