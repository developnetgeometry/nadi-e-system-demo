      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <FormField control={form.control} name="employee" render={({
            field
          }) => <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      {employees.map(employee => <SelectItem key={employee.id} value={employee.name}>
                          {employee.name}
                        </SelectItem>)}
                    </SelectContent>
                  </Select>
            ...
            field
                  ...
                  <FormControl>
                    <Textarea placeholder="Please provide details for your leave request" className="resize-none" rows={4} {...field} />
                  </FormControl>
                  <FormDescription>
            ...
            <DialogFooter>
              ...
              <Button type="submit" className="bg-[#8079b9]">Submit Request</Button>
            </DialogFooter>
          </form>
        </Form>
      </DialogContent>
