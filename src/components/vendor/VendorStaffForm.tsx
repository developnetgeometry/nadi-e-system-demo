...
export const VendorStaffForm: React.FC = () => {
  ...
  const onSubmit = async (data: VendorStaffFormData) => {
    ...
    try {
      ...
      const staffData = {
        ...
        position_id: 2,
        registration_number: selectedVendor.id,
        is_active: true,
    ...
    <div>
      <PageContainer>
        ...
        <PageHeader
          ...
          description="Register a new vendor staff for a specific company"
        />
              ...
              <CardContent className="space-y-4">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                  <p className="text-sm text-blue-800">
                    <strong>Note:</strong> This form will create a Vendor staff.
                  </p>
                </div>
