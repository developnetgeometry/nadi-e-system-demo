...
import { X, Filter, RotateCcw, Users, Building, Building2, Calendar, Download, Upload, ChevronsUpDown, Check, Box, Globe, Mail } from "lucide-react";
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        ...
        )}        {/* Statistics Cards Grid based on the image */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="overflow-hidden shadow-sm border border-gray-200">
            ...
            <CardContent className="p-6 bg-white flex flex-col items-center">              <div className="flex items-center gap-3 mb-2">
              ...
              <div className="mt-2 flex flex-col items-center">
                <div className="flex items-baseline gap-1">
                  ...
                  <span className="text-lg text-gray-500 font-medium">/93</span>
                </div>
                ...
                <span className="text-sm font-medium text-gray-600 mt-2">83% Completion</span>
              </div>
            </CardContent>
          </Card>

          {/* Website Migration Card */}
          <Card className="overflow-hidden shadow-sm border border-gray-200">
            <CardHeader className="p-4 bg-white border-b">
            ...
            <CardContent className="p-6 bg-white flex flex-col items-center">              <div className="flex items-center gap-3 mb-2">
              ...
              <div className="mt-2 flex flex-col items-center">
                ...
                <span className="text-sm font-medium text-gray-600 mt-2">71% Completion</span>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="overflow-hidden shadow-sm border border-gray-200">
            ...
            <CardContent className="p-6 bg-white flex flex-col items-center">              <div className="flex items-center gap-3 mb-2">
              ...
              <div className="mt-2 flex flex-col items-center">
                <div className="flex items-baseline gap-1">
                  <span className="text-4xl font-bold text-gray-800">81</span>
                  <span className="text-lg text-gray-500 font-medium">/93</span>
                </div>
                <div className="w-full bg-gray-100 rounded-full h-2 mt-3 max-w-[200px]">
                  <div className="bg-green-500 h-2 rounded-full" style={{ width: '86%' }}></div>
                </div>
                <span className="text-sm font-medium text-gray-600 mt-2">86% Completion</span>
              </div>
            </CardContent>
          </Card>
        </div>
